...
def ReadHierarchicalVerilogToGraph(modulepath, topmodule_name,current_node_idx,IsTopModule,logfile=None):
    ...
    if(IsTopModule):
        ...
        readme = []
        node_labels,readme,current_idx = GetNodeLabelFromModuleDict(module_dict,readme,node_labels,starting_idx=0)
        idx = current_idx
...
def GetNodeLabelFromModuleDict(module_dict,readme,node_labels,starting_idx=0):
    ...
    for idx,mod in enumerate(module_dict['Modules']):
        ...
        if(bool(module_dict['Modules'][mod]['Modules'])):
            node_labels,readme,current_idx = GetNodeLabelFromModuleDict(module_dict['Modules'][mod],readme,node_labels,starting_idx=idx)
        idx=current_idx
